...
Adafruit_NeoPixel strip(LED_COUNT, LED_PIN, NEO_GRB + NEO_KHZ800); //defining neoPixel object
...
void loop()
{
  ...
  {
    String startCommand = Serial.readString();
    if (startCommand == "start");
    {
      ...
      nano.stopReading();   //Stopscanning for tags
      count = 0;
